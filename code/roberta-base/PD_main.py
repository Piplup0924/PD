...
# wandb_logger = WandbLogger(project="PD", name= "roberta-1fold")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_save_path", type=str,
                        default="/home/hutu/PersonaDataset/PD/code/roberta-base/weight".format(WORKING_DIR), help="ckpt_save_path")
