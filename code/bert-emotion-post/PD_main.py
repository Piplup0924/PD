...
# wandb_logger = WandbLogger(project="PD", name= "bert-emotion-post")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_save_path", type=str,
                        default="/home/hutu/PersonaDataset/PD/code/bert-emotion-post/weight".format(WORKING_DIR), help="ckpt_save_path")
