...
wandb_logger = WandbLogger(project="PD", name= "roberta-emotion")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_save_path", type=str,
                        default="/home/hutu/PersonaDataset/PD/code/roberta-emotion/weight".format(WORKING_DIR), help="ckpt_save_path")
    ...
    parser.add_argument("--pretrained_path", type=str,
                        default="/home/hutu/PersonaDataset/xlm-roberta-base".format(WORKING_DIR), help="pretrained_path")
