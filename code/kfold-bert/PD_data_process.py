...
class EEProcessor(DataProcessor):
    ...
    def create_dataset(self, dialog ,label , batch_size, shuffle=False, max_length=512):
        ...
        # )
    def create_dataloader(self, is_train, dialog ,label , batch_size, shuffle=False, max_length=512):

        self.create_dataset(dialog ,label , batch_size, shuffle, max_length)
